...
class ModelTests: XCTestCase {
    ...
    func testSettingsModelType() {
        ...
        XCTAssert((settings.consensusBuilding as Any) is Bool, "SettingsModel().consensusBuilding is Bool")
        ...
        XCTAssert((settings.isFirstStars as Any) is Bool, "SettingsModel().isFirstStars is Bool")
        XCTAssert((settings.isFirstNegative as Any) is Bool, "SettingsModel().isFirstNegative is Bool")
