...
extension SignalType {
	...
	public func collect(_ predicate: (_ values: [Value]) -> Bool) -> Signal<[Value], Error> {
		return Signal { observer in
	...
	public func collect(_ predicate: (_ values: [Value], _ next: Value) -> Bool) -> Signal<[Value], Error> {
		return Signal { observer in
			let state = CollectState<Value>()
