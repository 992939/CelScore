...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-CelScore/AWSCore.framework"
  install_framework "Pods-CelScore/AsyncDisplayKit.framework"
  install_framework "Pods-CelScore/BEMCheckBox.framework"
  install_framework "Pods-CelScore/Bolts.framework"
  install_framework "Pods-CelScore/Dwifft.framework"
  ...
  install_framework "Pods-CelScore/OpinionzAlertView.framework"
  install_framework "Pods-CelScore/PINCache.framework"
  install_framework "Pods-CelScore/PINRemoteImage.framework"
  install_framework "Pods-CelScore/Rswift.framework"
  install_framework "Pods-CelScore/RateLimit.framework"
  ...
  install_framework "Pods-CelScore/RevealingSplashView.framework"
  install_framework "Pods-CelScore/SDWebImage.framework"
  install_framework "Pods-CelScore/SIAlertView.framework"
  install_framework "Pods-CelScore/SMSegmentView.framework"
  install_framework "Pods-CelScore/SVProgressHUD.framework"
  install_framework "Pods-CelScore/SwiftyJSON.framework"
  install_framework "Pods-CelScore/Timepiece.framework"
  install_framework "Pods-CelScore/UAObfuscatedString.framework"
