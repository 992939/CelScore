...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-TheObservatory/Realm.framework"
  install_framework "Pods-TheObservatory/RealmSwift.framework"
  install_framework "Pods-TheObservatory/Result.framework"
