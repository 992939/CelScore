...
final class DetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.ratingsVM.updateUserRatingsSignal(ratingIndex: 3, newRating: 4).start()
        self.ratingsVM.updateUserRatingsSignal(ratingIndex: 4, newRating: 4).start()
        self.ratingsVM.updateUserRatingsSignal(ratingIndex: 5, newRating: 4).start()
