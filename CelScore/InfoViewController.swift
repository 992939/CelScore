...
final class InfoViewController: ASViewController, Labelable {
    ...
    func createCelScoreText(score: Double) -> NSAttributedString {
        ...
        let attr1 = [NSFontAttributeName: UIFont.systemFontOfSize(13.0), NSForegroundColorAttributeName : percent >= 0 ? Constants.kDarkShade : Constants.kWineShade]
        attributedText = NSMutableAttributedString(string: percentage, attributes: attr1)
        let attr2 = [NSFontAttributeName: UIFont.systemFontOfSize(Constants.kFontSize), NSForegroundColorAttributeName : percent >= 0 ? Constants.kDarkShade : Constants.kWineShade]
