...
public enum OverlayInfo: Int {
    ...
    public func message() -> String {
        ...
        case .MenuAccess: return "Welcome aboard the consensus,\n\na space where no pledge nor oath is required,\na space where you only need some basic identification to get started."
        case .LoginSuccess: return "Welcome to the courthouse,\nthe court where we share opinions and values,\nthe court where we come together to build consensus.\n\nPlease, vote responsibly."
