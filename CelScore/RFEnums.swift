...
enum OverlayInfo {
    ...
    func message(_ social: String = "") -> String {
        ...
        case .socialSharing: return "Good fans are fans who share on social media\n\ndiehard fans are fans who rule social media."
        ...
        case .noSharing: return "Good fans are fans who share on social media.\n\nDiehard fans are fans who rule social media.\n\nGo to settings to enable social sharing."
