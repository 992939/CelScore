...
public enum OverlayInfo: Int {
    ...
    public func message() -> String {
        ...
        case .FirstStars: return "\"We are dealing with the stars in terms of their signification, not with them as real people.\"\n- Richard Dyer\n\nIn the Courthouse of Public Opinion stars are symbols, and the consensus a journey to explore the values they contain, to find star qualities, to reveal what makes their light shine bright."
