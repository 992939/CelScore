...
public class PRDCelScoreAPIClient: AWSAPIGatewayClient {
    ...
    /*
     ...
     return type: Empty
     */
    public func celebinfoscanservicePost() -> AWSTask<Empty> {
	    ...
	    return self.invokeHTTPRequest("POST", urlString: "/celebinfoscanservice", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: nil, responseClass: Empty.self) as! AWSTask<Empty>
	}
